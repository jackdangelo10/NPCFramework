...
import characters.FamilySearch;
import characters.NPC;
import characters.NPCGenerator;
import characters.RelationshipFinder;

public class NPCTreeTestSuit 
{
    public static void main(String[] args) 
    {
        ...
        List<characters.Character> people = search.search(joey, "Sibling");
        for(characters.Character i : people)
        {
